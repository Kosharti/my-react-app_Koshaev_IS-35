...
const Card: React.FC<CardData> = ({ name, email, phone, address, imageUrl, title, aboutMe }) => {
  return (
            ...
            <div className={styles.profileContent}>
                <div className={styles.profileHeader}>
                    ...
                    <div className={styles.skills}>
                        <button className={styles.skillButton}>Figma</button>
                        <button className={styles.skillButton}>UI Design</button>
                        <button className={styles.skillButton}>UX Design</button>
                    </div>
                </div>
                ...
                <div className={styles.contentRow}>
                    ...
                    <div className={styles.contactInfo}>
                        ...
                        <button className={`${styles.contactButton} ${styles.downloadResume}`}>Download Resume</button>
                        <button className={`${styles.contactButton} ${styles.message}`}>Message</button>
                    </div>
